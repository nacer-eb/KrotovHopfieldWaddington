...
def single_n(nT_merge):
    ...
    # Saving initial conditions in case we need to debug 
    ...
    # Training & Saving the network - 3500 seems to be good enough and saves space
    ...
    # See Readme if you have a bug here
