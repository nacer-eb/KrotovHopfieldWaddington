...
class KrotovNet:
    ...
    def visibleLayer_train(self, v, t):
        ...
        dV_1 = ( np.power(c - t_, 2*self.m_deg - 1,  dtype="double")  )*(1-c*c)*self.hiddenDetectors
    ...
    def hiddenLayer_train(self, v, t):
        ...
        dV_1 = ( np.power(c - t_, 2*self.m_deg - 1, dtype="double") )*(1-c)*(1+c)
    ...
    def train_plot_update(self, epochs, isPlotting=True, isSaving=False, saving_dir=None, testFreq=100, testingRegiment=[1, 0, 0], isDecay=False):
        """
        Train & Plot function.
