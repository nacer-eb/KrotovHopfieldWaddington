...
for n in [30]:
    ...
    np.save(data_dir+"/memory_umap_embed_correlation_n"+str(n)+str(selected_digits), M_embedding)
    ...
    ani.save(data_dir+'tmp' + str(selected_digits) + "_n" + str(n) +'.mp4', writer="ffmpeg")
