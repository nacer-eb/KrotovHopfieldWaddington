...
n = 30
M_embedding = np.load(data_dir+"/memory_umap_embed_correlation_n"+str(n)+"[1, 4, 7].npy")


tmax, N_mem = np.shape(M_embedding)[0], np.shape(M_embedding)[1]
print("------>", tmax)

t_s = [10, 21, 30, 40, 100, 150, 290] #n=3
t_s = [20, 34, 44, 59, 90, 150, 290]#n=15
t_s = [20, 64, 100, 121, 145, 213, 290]#n=30
