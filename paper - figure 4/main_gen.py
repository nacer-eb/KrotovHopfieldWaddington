...
for noise_r in [8]:#range(9, 11):
    for temp in [700]:#[400, 550, 670]:#[800, 850]:
        for n in [15, 39]:#[30]:#[3, 15, 30]:#[5, 10, 30]:#np.arange(2, 32, 1):
            for (alpha, l_0) in [(0.2, 0.5)]:#[(0.2, -0.5), (0.8, 0.5)]:
                print(n, temp)
                ...
                net = KrotovNet(Kx=2, Ky=1, n_deg=n, m_deg=n, M=2, nbMiniBatchs=1, momentum=0*0.6, rate=0.0004*2, temp=temp, rand_init_mean=-0.001, rand_init_std=r, selected_digits=[1, 4])
