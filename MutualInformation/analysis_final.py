...
fig, axs = plt.subplots(2, 2, figsize=(16, 9), dpi=280)
...
ax.set_ylabel(r"Maximum " + r'$ | \alpha | $ ')
...
#ax.set_xlabel("n-power")
ax.set_ylabel("Fixed Shannon Entropy")
...
ax.set_xlabel("n-power")
ax.set_ylabel("Useful Training Samples")
...
ax.set_xlabel("n-power")
ax.set_ylabel("Variable Shannon Entropy")


from matplotlib.lines import Line2D
custom_lines = [Line2D([0], [0], color=colors[0], marker="", lw=4, alpha=0.2),
                Line2D([0], [0], color=colors[1], marker="", lw=4, alpha=0.2),
                Line2D([0], [0], color=colors[2], marker="", lw=4, alpha=0.2)]

fig.legend(custom_lines, [r'$T=550$', r'$T=650$', r'$T=750$'], loc='upper center', ncol=4)

plt.tight_layout()
plt.subplots_adjust(top=0.87, wspace=0.3, hspace=0.2)
