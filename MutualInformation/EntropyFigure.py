...
from EntropyFigure_functions import *

fig = plt.figure(figsize=(16*2+2, 69-19+1))
...
custom_lines = [Line2D([0], [0], color="blue", lw=20, marker="", alpha=0.2),
                ...
                Line2D([0], [0], marker="o", markeredgecolor="k", markerfacecolor="white", markeredgewidth=4, linestyle="", ms=40)]

fig.legend(custom_lines, ['T=550', 'T=650', 'T=750',  'Training Data',  'Memory (Visible layer)'], loc='upper center', ncol=2)



plot_max_alpha(axs['1'])
plot_variable_shannon(axs['2'], isFirstRun=False)
...
axs['a'].set_title("T="+str(temp_range[1]), fontsize=55, pad=75, bbox=props)
axs['b'].set_title("T="+str(temp_range[-1]), fontsize=55, pad=75, bbox=props)
