...
f3 = Figure_6("run_[1, 4]_n15_T700_alpha0.8_l_00.5.npz") 
...
dx_adjust = 0.02
dy_adjust = 0.0
center_ax_3d = fig.add_axes([default_pos_ax2.x0 + dx_adjust-0.05,
...
center_ax_3d.view_init(elev=15)

center_ax_3d.set_box_aspect((1.5, 1.5, 2))
...
center_ax_3d.set_zticks([30, 60])
center_ax_3d.tick_params(axis='z', which='major', pad=15)
center_ax_3d.set_zticklabels([30, 60])
...
for i, n in enumerate(n_range):
    # Create Figure 6 Obj
    f3 = Figure_6("run_[1, 4]_n"+str(n)+"_T700_alpha0.8_l_00.5.npz")
