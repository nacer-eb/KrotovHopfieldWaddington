...
def single_n(nT_merge):
    ...
    net.train_plot_update(3500, isPlotting=False, isSaving=True, saving_dir=data_dir+prefix+"trained_net_n"+str(n)+"_T"+str(temp)+".npz", testFreq=500, noiseStd=initial_noise)
    
    # This needs a fix 
    generate_umap_embedding(data_dir, prefix, n, temp, verbose=False)
...
if __name__ == '__main__':
    ...
    if not path.exists(data_dir+prefix):
        ...
        details = "The networks contain " + str(net.K) + " memories. \n" +\
            ...
            "This network has training noise equal to the initial noise.\n" +\
