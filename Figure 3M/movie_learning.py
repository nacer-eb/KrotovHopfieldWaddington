...
im_d = [0]*10
for d in range(10):
    im_d[d], = axs[str(d)].plot(data_L[t, :, d], range(100), color=tab10_cmap(tab10_norm(d)), linestyle="", marker=".", ms=10)
...
axs['U'].scatter(embedding[:, 0], embedding[:, 1], c=keys, cmap="tab10", s=80, marker="*") # Plotting the UMAP training data
